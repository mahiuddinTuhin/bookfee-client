  ...
  return (
    <NavLink to={`/category/${cat?.cat_id}`} className="">
      <div className="flex justify-center items-center">
        <div
          className="rounded-md shadow-lg flex flex-col justify-between w-72 sm:w-96 h-96 bg-white bg-center text-gray-800  overflow-hidden cursor-pointer bg-cover"
          style={{
